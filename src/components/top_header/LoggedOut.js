...
<Link to="/">
  ...
  <ul className="navbar bg-dark" id="branddiv" >
    ...
    <button className="btn btn-outline-primary" onClick={() => setOpen(!open)} id="btn"> <i class="fa fa-shopping-cart" ></i></button>
</Link>
...
<button  style={{display:'none'}} className="btn circled" type="button" onClick={()=>{history.push("/profile")}}  id="userbutton" ><i className="fa fa-user-circle-o"  ></i></button>
{/**------------------------------------------------------------------------------------------------------------------------------------------------ */}
...
<button  style={{display:'none'}} className="btn circled" type="button" onClick={()=>{history.push('./profile')}}  id="userbutton" ><i className="fa fa-user-circle-o"  > Profile</i></button>
{/**------------------------------------------------------------------------------------------------------------------------------------------------ */}
