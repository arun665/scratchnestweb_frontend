...
import "./circulara.css";

import { useState } from "react";
import AOS from "aos";
import Featurecaurosel from "./Caurosel/Featurecaurosel_Circular.js";
...
import Collapsable from "./Collapsable/Collapsable_Circular.js";
...
function CircualrAnt(props: any) {
  ...
  return (
    <div className="pirrfid">
      <IonGrid className="pgridrfid">
        <IonRow className="rowirp_player grbg">
          <IonCol size="12" className="hdl imgdl">
            <ReactPlayer
              url="https://res.cloudinary.com/dpysmqax5/video/upload/v1618748789/anteena_circular_lmb9az.mp4"
              width="100vw"
              height="95vh"
              playing={true}
              muted={true}
          ...
          <IonRow className="pd_rowir_des">
            <IonCol size="11" className="pd_txt_colir">
              <IonText className="pd_irtext bd_500">
                The ScratchNest SN-CA 101 is a far-field 9 dBi circular
                polarized RFID antenna that provides reception and transmission
                of signals in the UHF frequency band. Both US and EU versions
                are available in this model. The ScratchNest far-field RFID
                antenna comes with a heavy-duty polycarbonate housing, possesses
                female TNC connectors and excellent VSWR and axial ratios.
              </IonText>
            </IonCol>
          </IonRow>
        ...
        <IonRow className="circular_img1_product" data-aos="zoom-in-right">
          <IonCol size="12" className="imgcol_circular_p"></IonCol>
        </IonRow>
        <IonRow className="ipr_img1_product" data-aos="zoom-in-left">
          <IonCol size="12" className="imgcol_circular_p2"></IonCol>
        </IonRow>
