...
{/* the selected item starts here -----------------------------------------------------------------------------------*/}
 ...
 <div class="input-group">
                  ...
                  <input type="text" id="quantity" name="quantity" class="form-control input-number" value={12} />
                  <span class="input-group-btn">
...
{/*------------------------------------------------------------*/}
            ...
            <table>
              <tr>
                <td>
                  <h2>Price: 1 cr{/*<span>( <del>₹ {post.price + (post.price / 10)} </del>) </span>  <span id="span2">₹ {post.price} </span>*/}  </h2>
                </td>
                <td>
                {/*  <button className="btn btn-outline-danger" id="delete" value={post.productId} onClick={() => this.doDelete(post.productId)}> */}
                  <button className="btn btn-outline-danger" id="delete" > {/*value={post.productId}*/}
 ...
 <div class="input-group">
                  ...
                  <input type="text" id="quantity" name="quantity" class="form-control input-number"  value={12} /> {/* value={post.qty} */}
                  <span class="input-group-btn">
                   {/*   <button type="button" class="quantity-right-plus btn btn-success btn-number button2" data-type="plus" data-field="" value={post.productId} onClick={() => this.doIncrease(post.productId)}>*/}
                      <button type="button" class="quantity-right-plus btn btn-success btn-number button2" data-type="plus" data-field="" >
...
{/*------------------------------------------------------------*/}
                ...
                <td>
             {/*   <button className="btn btn-outline-danger" id="delete" value={post.productId} onClick={() => this.doDelete(post.productId)}> */}
                <button className="btn btn-outline-danger" id="delete" >
